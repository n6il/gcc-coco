/*
 * $Header: /cvsroot-fuse/gcc-coco/libc-coco-rsdos/gcc/m6809/m6809.h,v 1.2 2004/08/07 11:30:09 skwirl42 Exp $
 */
/*-------------------------------------------------------------------
	FILE: m6809.h
...
/* don't do this, we need char args for interrupt routines */
...
#define HANDLE_PRAGMA(GETC, UNGETC, NODE) handle_pragma (GETC, UNGETC, NODE)
...
#define ASM_FILE_START(FILE) \
    ...
    fprintf (FILE, ";;; MC6809 $Revision: 1.2 $\n"); \
    print_options (FILE); 
...
#define TEXT_SECTION_ASM_OP ("\t.area _CODE")

/* Output before writable data.  */
#define DATA_SECTION_ASM_OP ("\t.area _DATA") 

/* Output before uninitialized data.  */
#define BSS_SECTION_ASM_OP ("\t.area _BSS") 
